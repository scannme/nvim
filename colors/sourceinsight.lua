...
hi("Search",        { fg = p.fg,       bg = p.hl_yellow })
...
hi("Todo",          { fg = p.red_b,    bg = p.hl_yellow, bold = true })
...
hi("DiffText",      { bg = p.hl_yellow, bold = true })
...
hi("LspSignatureActiveParameter", { fg = p.fg, bg = p.hl_yellow, bold = true })
...
hi("@variable.member",     { fg = p.magenta_b })
hi("@constant",            { fg = p.red })
...
hi("@property",            { fg = p.magenta_b })
hi("@field",               { fg = p.magenta_b })
...
hi("@lsp.type.variable",          { fg = p.green })
hi("@lsp.type.parameter",         { fg = p.fg_dim,  italic = true })
hi("@lsp.type.property",          { fg = p.magenta_b })
...
hi("@lsp.typemod.variable.global",           { fg = p.green,   bold = true })
hi("@lsp.typemod.variable.definition",       { fg = p.green,   bold = true })
...
hi("@lsp.typemod.property.declaration",      { fg = p.magenta_b, bold = true })
